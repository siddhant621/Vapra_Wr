    ...
    <div>
      <Card className="bg-muted/20 border-emerald-900/20">
        <CardHeader>
          ...
          <CardDescription>Review payout requests</CardDescription>
        </CardHeader>
        <CardContent>
          {payouts.length === 0 ? (
            ...
            <div className="space-y-6 py-4">
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                  <User className="h-5 w-5 text-emerald-400" />
                  <h3 className="text-white font-medium">Mechanic Information</h3>
                </div>
              ...
              {selectedPayout?.note && (
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-white font-medium">Admin Note</h3>
                  </div>
                  <p className="text-muted-foreground">{selectedPayout.note}</p>
                </div>
              )}
            </div>
